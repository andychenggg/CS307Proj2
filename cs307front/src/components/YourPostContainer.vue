  ...
  <div class="container">
    <div class="main-content" id="content">
      ...
      <el-button type="primary" round style="width: 200px; height: 40px; margin: 20px"
                 @click="fetchYourPostData" v-if="!noMorePost">To See More...
      </el-button>
...
export default {
  ...
  mounted() {
    // 组件创建时要执行的操作
    console.log('YourPostPostContainer created!');
