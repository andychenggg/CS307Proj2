<template>
  <div class="comment">
    <div class="comment-header">
      ...
      <el-switch v-model="switchValue" active-color="#13ce66" inactive-color="#ff4949" active-text="public"
                 inactive-text="anonymous" @change="toggleSwitch"></el-switch>
    </div>
      ...
      <div class="first-comment">
        ...
        <div class="content">
          ...
          <div style="display: flex">
            ...
            <div
                style="min-width: 120px; height: 30px; justify-content: center; display: flex; font-weight: bold; align-items: center;">
              Reply To:
            </div>
  ...
  methods: {
    addPostReply() {
      ...
      const data = {
        ...
        anonymous: !this.switchValue,
        orginalanonymous: this.orginalanonymous
      };
    ...
    addComment(item) {
      ...
      const data = {
        ...
        anonymous: !this.switchValue,
        orginalanonymous: item.anonymous,
      };
      axios.post(url, data, {
        withCredentials: true
      })
